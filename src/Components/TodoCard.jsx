  ...
  return (
    <div class="flex flex-col justify-center items-center">
      <div class="flex justify-center items-center w-96">
        <div class="max-w-sm p-6 border border-gray-200 rounded-lg shadow dark:border-gray-700 w-full h-48 flex flex-col justify-evenly items-center shadow-2xl">
      ...
      <div class="border border-gray-200 rounded-lg shadow dark:border-gray-700 w-4/6 flex flex-col justify-evenly items-center shadow-2xl my-8">
        ...
        <div class="my-6 text-lg w-64 mx-4">
          {todo?.length > 0 ? (
            todo?.map((item, index) => (
              <div class="p-3 my-5 border border-gray-200 rounded-lg shadow dark:border-gray-700 flex flex-col justify-between items-center shadow-2xl">
                <div>
                  {item}
